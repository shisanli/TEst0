...
{
    public partial class FormPatientQuery : Form
    {
        private PatientQueryCondition? condition;
        public FormPatientQuery()
        {
            InitializeComponent();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 10, 10));
        }
        public FormPatientQuery(PatientQueryCondition c)
        {
            condition = c;
            InitializeComponent();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 10, 10));

            dtpBegain.Format = DateTimePickerFormat.Custom;
            dtpBegain.CustomFormat = "   ";
        ...
        private void DtpBegain_ValueChanged(object sender, EventArgs e)
        {
            dtpBegain.Format = DateTimePickerFormat.Long;
            dtpBegain.CustomFormat = null;
        }
