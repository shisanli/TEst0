...
namespace PressureUpper
{
...

    {
        ...
        public float[] PressureV2 = new float[66];
        public float[] PressureBufferV2 = new float[66];
        ...
        public DrawFunction3D.PointF3D PressureCentre
        {
            get
            {
                ...
                DrawFunction3D.PointF3D centre = new DrawFunction3D.PointF3D(350, 250, 50);
                return centre;
            }
        }
        ...
        {
            PressureV2 = new float[66];
            PressureV2 = (float[])PressureBufferV2.Clone();

        }

        public void ConvertV2()
        {
            if (FormPressureMock.Mocking)
            {
                FormPressureMock.PressureMock.CopyTo(PressureV2,0);
                return;
            }
            PressureBufferV2.CopyTo(PressureV2,0);
