...
{
    public class DrawClosedCurve : DrawListPoints
    {
         
        public DrawClosedCurve(DrawFunction3D IndexDrawFunction)
        {
        ...
        public DrawClosedCurve(DrawFunction3D IndexDrawFunction, Pen DrawPen)
        {
            this.pen_DrawPen = Pens.Black;
            this.IndexDrawFunction = IndexDrawFunction;
        ...
        public DrawClosedCurve(DrawFunction3D IndexDrawFunction, Pen DrawPen, DrawFunction3D.PointF3D[] PointList)
        {
            this.pen_DrawPen = Pens.Black;
            this.IndexDrawFunction = IndexDrawFunction;
            this.DrawPen = DrawPen;
        ...
        public override void DrawPart(Graphics DrawGraph)
        {
            checked
            {
                if (this.PointList.Length > 0 & this.IndexDrawFunction != null)
                {
                    ...
                    DrawGraph.DrawClosedCurve(this.DrawPen, array);
                }
            }
        }
        ...
        {
            return new DrawClosedCurve(this.IndexDrawFunction, (Pen)this.DrawPen.Clone(), this.ClonePointList());
        }
