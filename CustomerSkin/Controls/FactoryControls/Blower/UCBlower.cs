...
namespace CustomerSkin.Controls
{
    ...
    public class UCBlower : UserControl
    {
        ...
        public TurnAround TurnAround
        {
            ...
            {
                turnAround = value;               
                if (value == CustomerSkin.Controls.TurnAround.None)
                {
        ...
        {
            if (turnAround == CustomerSkin.Controls.TurnAround.Clockwise)
            {
                jiaodu += 15;
                if (jiaodu == 45)
                    jiaodu = 0;
            }
            else if (turnAround == CustomerSkin.Controls.TurnAround.Counterclockwise)
            {
                jiaodu -= 15;
                if (jiaodu == -45)
                    jiaodu = 0;
