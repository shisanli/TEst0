...
namespace CustomerSkin
{
    public class SkinFormProfessionalRenderer : SkinFormRenderer
    {
        ...
        //画圆角
        public override Region CreateRegion(CustomerSkinMain form)
        {
        ...
        public override void InitSkinForm(CustomerSkinMain form)
        {
            ...
            SkinFormCaptionRenderEventArgs e)
        {
            ...
            CustomerSkinMain form = e.SkinForm;
        ...
        private void DrawBorder(
            Graphics g, Rectangle rect, RoundStyle roundStyle, int radius, CustomerSkinMain frm)
        {
        ...
        //画自定义系统按钮集合
        private void RenderSkinFormCmSysBottomInternal(Graphics g, Rectangle rect, ControlBoxState state, bool active, CustomerSkinMain form, CmSysButton cmSysButton)
        {
            Bitmap btm = null;
            Color baseColor = ColorTable.ControlBoxActive;
