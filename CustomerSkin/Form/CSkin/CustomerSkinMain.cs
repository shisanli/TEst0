...
{
    public partial class CustomerSkinMain : Form
    {
        #region 变量
        //绘制层
        public CustomerSkinForm skin;
        ...
        protected override void OnCreateControl()
        {
            ...
            SetReion();
            if (this.Owner is CustomerSkinMain && this.InheritBack)
            {
                CustomerSkinMain main = (CustomerSkinMain)this.Owner;
        ...
        void main_BackChanged(object sender, BackEventArgs e)
        {
            if (this.InheritBack)
            {
                CustomerSkinMain main = (CustomerSkinMain)sender;
                this.BackToColor = true;
                this.Back = main.Back;
                this.BackLayout = main.BackLayout;
            }
        ...
        protected override void OnClosed(EventArgs e)
        {
            ...
            if (Special && !DesignMode)
            {
                ...
                Win32.NativeMethods.AnimateWindow(this.Handle, 150, AW.AW_BLEND | AW.AW_HIDE);
                Update();
            }
        }
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            if (Visible)
            {
                ...
                if (Special && !DesignMode)
                {
                    ...
                    //淡入特效
                    Win32.NativeMethods.AnimateWindow(this.Handle, House, AW.AW_BLEND | AW.AW_ACTIVATE);
                    Opacity = SkinOpacity;
                    Update();
                }
                //判断不是在设计器中
                ...
                {
                    skin = new CustomerSkinForm(this);
                    skin.Show(this);
                }
                OneVisibles = false;
        ...
        protected void TrackPopupSysMenu(IntPtr hWnd, Point point)
        {
            ...
            {
                IntPtr hMenu = Win32.NativeMethods.GetSystemMenu(hWnd, false);
                IntPtr command = Win32.NativeMethods.TrackPopupMenu(hMenu,
                   TPM.TPM_RETURNCMD | TPM.TPM_TOPALIGN | TPM.TPM_LEFTALIGN,
                   point.X, point.Y, 0, hWnd, IntPtr.Zero);
                Win32.NativeMethods.PostMessage(hWnd, WM.WM_SYSCOMMAND, command, IntPtr.Zero);
            }
        }
