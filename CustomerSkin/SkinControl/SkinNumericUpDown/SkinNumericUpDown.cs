    ...
    public class SkinNumericUpDown : NumericUpDown
    {
        ...
        private class UpDownButtonNativeWindow : NativeWindow, IDisposable
        {
                ...
                : base()
            {
                ...
                {
                    if (Win32.NativeMethods.IsAppThemed())
                    {
                        Win32.NativeMethods.SetWindowTheme(_upDownButtonWnd, "", "");
                    }
                }
            ...
            private void DrawUpDownButton()
            {
                ...
                Win32.NativeMethods.GetWindowRect(_upDownButtonWnd, ref windowRect);

                mouseOver = Win32.NativeMethods.PtInRect(ref windowRect, cursorPoint);
