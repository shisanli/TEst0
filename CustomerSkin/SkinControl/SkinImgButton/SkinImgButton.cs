using CustomerSkin.SkinControl.UIEditor;
using System;
...
namespace CustomerSkin.SkinControl.SkinImgButton
{
    public partial class SkinImgButton : SkinButtonExt
    {
        /// <summary>
        /// The BTN text
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SkinImgButton" /> class.
        /// </summary>
        public SkinImgButton()
        {
            InitializeComponent();
            IsShowTips = false;
