...
namespace CustomerSkin.SkinControl
{
    ...
    public class SkinAlphaWaterTextBox : System.Windows.Forms.TextBox
    {
        ...
        protected override void OnGotFocus(EventArgs e)
        {
            ...
            myTimer1.Interval = (int)Win32.NativeMethods.GetCaretBlinkTime(); //  usually around 500;
        ...
        /// 用于显示水印文字的字体
        /// </summary>
        private Font _waterFont = new Font(CustomerSkin.Localization.Localizer.DefaultFont.FontFamily, 8.5f);
                            ...
                            ref System.Drawing.Bitmap bitmap)
        {
            ...
            Win32.NativeMethods.SendMessage(control.Handle, WM.WM_PRINT, (int)hdc, meptr);
        ...
        private Point findCaret()
        {
            ...
            int i_point = Win32.NativeMethods.SendMessage(this.Handle, EM.EM_POSFROMCHAR, (int)pi_char_loc, IntPtr.Zero);
            ...
            else if (i_char_loc >= this.Text.Length)
            {
                ...
                i_point = Win32.NativeMethods.SendMessage(this.Handle, EM.EM_POSFROMCHAR, (int)pi_char_loc, IntPtr.Zero);
                pointCaret = new Point(i_point);
        ...
        private class uPictureBox : PictureBox
        {
            ...
            protected override void WndProc(ref Message m)
            {
                    ...
                    || m.Msg == WM.WM_MOUSEMOVE)
                {
                    ...
                    Win32.NativeMethods.PostMessage(this.Parent.Handle, (int)m.Msg, m.WParam, m.LParam);
                }
