            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = CustomerSkin.Properties.Resources.alarm;
                        break;
