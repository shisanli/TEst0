...
using CustomerSkin.Controls;

namespace CustomerSkin.Forms
{
    /// <summary>
    /// Class FrmInputs.
    /// Implements the <see cref="CustomerSkin.Forms.FrmWithOKCancel1" />
    /// </summary>
    /// <seealso cref="CustomerSkin.Forms.FrmWithOKCancel1" />
    public partial class FrmInputs : FrmWithOKCancel1
    {
        ...
        public FrmInputs(
            ...
            Dictionary<string, CustomerSkin.Controls.KeyBoardType> keyBoards = null,
            ...
            Dictionary<string, string> defaultValues = null)
        {
            ...
            try
            {
                ...
                CustomerSkin.ControlHelper.FreezeControl(this, true);
                ...
                for (int i = inPutLabels.Length - 1; i >= 0; i--)
                {
                    ...
                    CustomerSkin.Controls.UCTextBoxEx txt = new Controls.UCTextBoxEx();
            ...
            {
                CustomerSkin.ControlHelper.FreezeControl(this, false);
            }
        }
        #endregion
        ...
        protected override void DoEnter()
        {
            for (int i = 0; i < Values.Length; i++)
            {
                ...
                if (cs.Length > 0)
                {
                    var txt = cs[0] as CustomerSkin.Controls.UCTextBoxEx;
                    Values[i] = txt.InputText;
                    if (m_mastInputs.ContainsKey(i) && string.IsNullOrWhiteSpace(txt.InputText))
                    {
                        CustomerSkin.Forms.FrmTips.ShowTipsInfo(this, "[" + m_mastInputs[i] + "]必须输入。");                        
